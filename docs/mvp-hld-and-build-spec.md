...
**(c) assemble — CODE.** Combines recommendation + dossiers + runner-up + decisive factors + open questions into `strategy.md` (the deliverable) and a `strategy.json` sidecar (section manifest + claim-ids) for the renderer. No new model call.
